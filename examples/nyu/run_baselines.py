...
combinations = list(product(n_values, weightings))
...
while combinations or running_processes:
    ...
    for gpu in gpus:
        while gpu_occupancy[gpu] < max_processes_per_gpu and combinations:
            n_val, weighting = combinations.pop(0)
            ...
            # Output filename
            output_file = f'./PSMGDVR_lower_lr_e-5/weighting_{weighting}_gamma_01.txt'
            ...
            print(f"Started: PSMGDVR n {n_val} weighting {weighting}, on GPU {gpu}")
